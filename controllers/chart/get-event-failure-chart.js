...
function EventFailureAuditChartController({makeGetEventFailureChart}){
    ...
    return async function handle(httpRequest){
        ...
        newbody=body;  
        //const result=await makeGetEventFailureChart(httpRequest.headers,body)
        const products=GetProductResponseHandler(await makeGetEventFailureChart(newbody))
        let result=products(makeGetEventFailureCharts);
    ...
    function makeGetEventFailureCharts(product) {
        return product      
}
}

module.exports=EventFailureAuditChartController